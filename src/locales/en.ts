export const en = {
  ...
  form: {
    ...
    apiBaseUrlTip: "Supports any OpenAI-compatible API (OpenRouter, DeepSeek, Together, etc.)",
    aiModelLabel: "AI Model Selection",
    fetchingModels: "Fetching available...",
    resilienceTip: "Multi-Provider:",
    resilienceDesc: "Cheat Clip now supports any OpenAI-compatible provider! Just enter your API key and base URL, then select any model. Works with OpenRouter, DeepSeek, OpenAI, Together, and more.",
  ...
  errors: {
    apiKeyRequired: "An API Key is required to analyze videos. Enter your API key in the field below.",
    ...
    getNewKeyLink: "Get a key from OpenRouter ↗",
  ...
  results: {
    ...
    noMarkedClipsNotice: "No clips marked yet. Check the box on any clip to mark it.",
    noMarkedClipsToast: "No marked clips found. Mark clips first using the checkboxes!",
